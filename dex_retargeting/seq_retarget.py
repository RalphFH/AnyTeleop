...
class SeqRetargeting:
    ...
    def warm_start_manitask(self,robot_uid:str):
        if robot_uid == "franka_panda":
            self.last_qpos = [  
                -1.6834,
                1.7638,
                0.91396,
            ...
            self.last_qpos = [  
                ...
                -0.13984,
                0.6955]
        elif robot_uid == "xarm7_allegro_right":
            self.last_qpos = [
                -0.86003,
                1.6606,
                1.0591,
        ...
        elif robot_uid == "xarm7_shadow_right":
            self.last_qpos = [
                -0.25794,
                1.3207,
                -0.21663,
        ...
        elif robot_uid == "xarm7_leap_right":
            self.last_qpos = [
                -0.29206,
                1.8811,
                -1.9237,
